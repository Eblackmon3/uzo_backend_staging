                    ...
                    if(phone_number.length()==10){
                        ...
                        try {
                            Message.creator(new PhoneNumber(phone_number),
                                    ...
                                    " A new job has been posted! please check the hhttps://uzo-frontend-dev.herokuapp.com/").create();
                        }catch(Exception e ){
                    ...
                    if(phone_number.length()==10){
                        try {
                            if (forWhat.equals("HKA")){
                                Message.creator(new PhoneNumber(phone_number),
                                        new PhoneNumber("6787265534"),
                                        "You have been accepted as an UZO Student! logon to the app hhttps://uzo-frontend-dev.herokuapp.com/ to start searching for jobs!").create();
                        }else if(forWhat.equals("job")){
                                Message.creator(new PhoneNumber(phone_number),
                                        new PhoneNumber("6787265534"),
                                        "You have been accepted for a new job! logon to UZO now to see what it is hhttps://uzo-frontend-dev.herokuapp.com//!").create();
